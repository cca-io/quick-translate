...
The app also supports a simplified key-value JSON layout for files without descriptions:
...
When the source file is JSON, the layout is detected automatically and JSON target imports/exports follow that same layout.
